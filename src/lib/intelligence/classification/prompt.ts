...
- "material_profissional" cobre pedidos sobre materiais de APRESENTAÇÃO/DIVULGAÇÃO do próprio profissional — bio, texto de apresentação, press kit, portfólio, fotos/vídeos promocionais, atualização de perfil público (ex.: "faz uma bio minha mais curta", "atualiza meu portfólio", "preciso de fotos novas pro Instagram"). NUNCA inclui documentação técnica de produção — isso é "rider", que tem intent próprio mesmo sendo tecnicamente um documento ("manda o rider" é sempre "rider", nunca "material_profissional"). NUNCA vire um intent genérico pra qualquer texto/redação — só quando o pedido é especificamente sobre a autoapresentação profissional do artista.
- "treinamento_profissional" x "suporte": os dois são sobre a relação do profissional com a própria Doopla (não com um cliente), mas são coisas diferentes. "treinamento_profissional" é o profissional dando uma PREFERÊNCIA ou INSTRUÇÃO sobre como a Doopla/o assistente deve se comportar ou tratá-lo dali em diante — está calibrando o assistente (ex.: "não me lembre mais no dia do show", "seja mais direto comigo", "manda menos notificação", "quero saber meu cachê da última vez com esse cliente"). "suporte" é o profissional relatando que ALGO NÃO FUNCIONA ou pedindo ajuda técnica com a plataforma em si (ex.: "não consigo entrar no painel", "o app travou", "não recebi o e-mail de confirmação"). A pergunta pra distinguir: o profissional está moldando o comportamento futuro do assistente (treinamento_profissional) ou relatando um problema técnico concreto (suporte)?
- "booking_update" x "logistica" quando o assunto é horário/data: a DATA/HORÁRIO EM QUE O TRABALHO ACONTECE é um termo central do acordo, no mesmo grupo de "o trabalho existe"/"o trabalho foi cancelado" — uma mudança nisso é sempre "booking_update" (ex.: "preciso trocar o horário do show", "mudou pra domingo"), nunca "logistica". "logistica" cobre coordenação de EXECUÇÃO de um evento cujos termos centrais já estão definidos — endereço, acesso, estacionamento, horário de chegada pra montagem de equipamento (ex.: "qual o endereço", "a que horas eu preciso chegar pra montar"). Nunca a data/horário do evento em si.
