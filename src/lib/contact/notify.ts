...
// notification_status='failed' pra follow-up manual. Resend ainda não
// está configurado (sem RESEND_API_KEY) — isso é esperado nesta etapa,
// não um bug.
...
export async function sendContactNotification(
  ...
  const from = process.env.CONTACT_EMAIL_FROM ?? `Doopla <${SUPPORT_EMAIL}>`;
