...
export default function Home() {
  return (
    <>
      ...
      {/* Nova Home (08/09/2026) — GSAP removido (decisão técnica, ver
          home.js): reveal-on-scroll agora é IntersectionObserver puro,
          zero script externo. Scripts com src injetados via
          dangerouslySetInnerHTML não executam (regra do DOM), por isso
          o script inline continua entrando via next/script. */}
