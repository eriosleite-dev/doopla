...
// Home LEGADA — Shell + Home bloco (04/09/2026) manteve este código
// intacto (mesma lógica, mesmo visual bege) pra role='booker' (e o
// legado role='agencia', que já caía aqui antes). A Home NOVA
// (professional-home-view.tsx) é exclusiva da superfície profissional
// — nunca Booker (DECISOES.md "Quatro superfícies distintas", Booker
// Web Dashboard segue fora de escopo). Extraído de page.tsx só pra
// isolar o narrowing de tipos do branch em page.tsx; comportamento
// 100% preservado.
export async function BookerHomeView({
  limiteBooker,
  supabase,
  user,
  profile,
