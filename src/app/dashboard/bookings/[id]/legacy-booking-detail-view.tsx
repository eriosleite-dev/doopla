...
const PAYMENT_DUE_CLASSES: Record<'a_vencer' | 'vencido' | 'em_cobranca', string> = {
...
// Booker/Agência — tema legado (--ink/--paper/font-doopla-display)
// intocado. Extraído literalmente do page.tsx original (Bloco 7, re-
// skin do Booking Detail) — zero mudança de lógica/copy/comportamento,
// só passou a viver num componente próprio pra page.tsx poder
// escolher entre esta view e ProBookingDetailView por role, mesmo
// padrão já usado em trabalhos/agenda/dinheiro.
export function LegacyBookingDetailView({
  booking,
  events,
  isProposer,
  checkpoints,
