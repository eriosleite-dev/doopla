...
import type { ReferralSummary } from './data';
...
// Shell LEGADO — Shell + Home bloco (04/09/2026) manteve este código
// intacto (mesmo bege/--sidebar) exclusivamente pra role='booker'
// (Booker Web Dashboard segue fora de escopo, DECISOES.md "Quatro
// superfícies distintas"). Extraído de layout.tsx só pra isolar o
// narrowing de tipos do branch em layout.tsx; comportamento 100%
// preservado.
