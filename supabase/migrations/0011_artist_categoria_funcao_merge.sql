-- Doopla — as perguntas "categoria principal" e "o que você faz?" do
-- cadastro do artista eram idênticas (mesmas opções), uma logo depois da
-- outra. Consolidadas numa única pergunta multi-select (categoria).
-- funcao continua existindo no banco (matching interno já depende dela)
-- e passa a ser gravada com o mesmo valor de categoria, só que sem
